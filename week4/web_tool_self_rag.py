...
os.environ["LANGCHAIN_API_KEY"] = "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"
...
# 温度0，不需要输出多样性
llm = ChatOpenAI(model_name="qwen2.5",api_key="ollama", base_url="http://192.168.1.111:11434/v1", temperature=0)
