...
import (
	...
	"github.com/lostar01/application/test/utils"
)
...
var (
	...
	projectImage = "example.com/application:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting application integration test suite\n")
